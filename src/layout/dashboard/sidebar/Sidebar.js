  ...
  return (
    <div id="bst-sidebar-wrapper">
      <div
        ...
        className={`${
          isCollapse ? "w-7 sync-collapse" : "w-210px"
        } toggle-sidebar collapse-horizontal show`}
      >
        ...
        >
          <Link to="/">
            <div className="d-flex-center justify-content-between">
              {isCollapse && (
                <img
                  src="/images/logo-collapse.png"
                  alt="logo.png"
                  className="w-100"
                />
              )}
              {!isCollapse && (
                <img src="/images/logo.png" alt="logo.png" className="w-80" />
              )}
            </div>
          </Link>
          <button
